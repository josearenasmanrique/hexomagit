...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $correoCliente = htmlspecialchars($_POST["correo"]);    $passCliente = htmlspecialchars($_POST["contrasena"]);    $rol = htmlspecialchars($_POST["rol"]);    $urlacargar = $_POST["urlaponer"];
    ...
    try {
        ...
        NoExterior_empleado = :no_exterior, 
        NoInterior_empleado = :no_interior, 
        Colonia_empleado = :colonia, 
        C_P_empleado = :codigo_postal, 
        Municipio_empleado = :municipio, 
        Estado_empleado = :estado, 
        Tel_empleado = :telefono, 
        cel_empleado = :celular, 
        Correo_empleado = :correo, 
        pass_empleado = :contrasena,
        rol = :rol
        WHERE idempleado = :id";
