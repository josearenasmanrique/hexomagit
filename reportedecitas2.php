...
$anoFiltrado = isset($_POST['filtroAno']) ? $_POST['filtroAno'] : ''; // Agregado para el filtro por año
...
try {
    ...
    ag.dia, ag.mes, ag.año, ag.horario
    FROM agenda AS ag
    ...
    AND (:anoFiltrado = '' OR ag.año = :anoFiltrado)  -- Agregado para el filtro por año
    ...
    $stmt->bindParam(':anoFiltrado', $anoFiltrado); // Agregado para el filtro por año
...
<div class="print-hidden">
    ...
    <form method="POST">
        ...
        <label for="filtroAno">Año:</label> <!-- Agregado para el filtro por año -->
        <select name="filtroAno" id="filtroAno"> <!-- Agregado para el filtro por año -->
            <option value="">Todos</option>
            <?php
            $anoActual = date("Y");
            for ($i = 2020; $i <= $anoActual; $i++) {
                echo "<option value='$i'>$i</option>";
            }
            ?>
        </select>
